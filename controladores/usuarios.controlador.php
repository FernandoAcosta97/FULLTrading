...
class ControladorUsuarios{
	...
	static public function ctrIngresoUsuario(){
		...
		if(isset($_POST["ingUsuario"])){
...

			{
				...
				if($respuesta["correo"] == $_POST["ingUsuario"] && $respuesta["clave"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						$_SESSION["operando"] = $respuesta["operando"];
					...
					swal({
						...
						type: "error",
						title: "¡El usuario  está desactivado! comunicate con soporte al correo soporte@trading.com",
					...
					swal({
						...
						type: "error",
						title: "¡Ups credenciales incorrectas, vuelve a intentarlo!",
						showConfirmButton: true,
						confirmButtonText: "Cerrar",
						closeOnConfirm: false
	...
	public function registroDeUsuario(){
		...
		if (isset($_POST["RegistroNombreUser"])){


		$tabla="usuario";
		$encriptar = crypt($_POST["RegistroClave"],'$2a$07$asxx54ahjppf45sd87a5a4dDDGsystemdev$');
		$datoscontroller = 




		 array("cedula"=>$_POST["RegistroCedula"],
		 	   "nombres"=>$_POST["RegistroNombres"],
		 	   "apellidos"=>$_POST["RegistroAepellidos"],
		 	   "correo"=>$_POST["RegistroCorreo"],
		 	   "telefono"=>$_POST["RegistroTelefono"],
		 	   "nombreusuario"=>$_POST["RegistroNombreUser"],
		 	   "clave"=>$encriptar,
		 ...
		 $respuesta = datos::registroUserModelo($datoscontroller,$tabla);
